...
<div className="relative overflow-hidden before:absolute before:top-0 before:start-1/2 before:bg-[url('https://preline.co/assets/svg/examples/polygon-bg-element.svg')] dark:before:bg-[url('https://preline.co/assets/svg/examples-dark/polygon-bg-element.svg')] before:bg-no-repeat before:bg-top before:bg-cover before:size-full before:-z-[1] before:transform before:-translate-x-1/2">
  <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
    ...
    <div className="mt-5 max-w-3xl text-center mx-auto">
      ...
      Transforme seus ambientes com IA: Crie seu Design de Interiores em apenas um clique!</p>
    </div>
...
<div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  <div className="grid sm:grid-cols-2 lg:grid-cols-4 items-stretch gap-2">
    <a className="group flex flex-col justify-between h-full hover:bg-gray-50 rounded-xl p-4 md:p-7 dark:hover:bg-neutral-800" href="#">
      ...
      <div className="mt-5 flex-1">
        ...
        <p className="mt-1 text-gray-600 dark:text-neutral-400">Carregue sua imagem do seu quarto</p>
      </div>
    ...
    <a className="group flex flex-col justify-between h-full hover:bg-gray-50 rounded-xl p-4 md:p-7 dark:hover:bg-neutral-800" href="#">
      ...
      <div className="mt-5 flex-1">
        <h3 className="group-hover:text-gray-600 text-lg font-semibold text-gray-800 dark:text-white dark:group-hover:text-gray-400">Selecione o Design</h3>
        <p className="mt-1 text-gray-600 dark:text-neutral-400">Selecione o Design e o tipo de ambiente</p>
      </div>
      <span className="mt-2 inline-flex items-center gap-x-1.5 text-sm text-blue-600 decoration-2 group-hover:underline font-medium">
    ...
    <a className="group flex flex-col justify-between h-full hover:bg-gray-50 rounded-xl p-4 md:p-7 dark:hover:bg-neutral-800" href="#">
      ...
      <div className="mt-5 flex-1">
        <h3 className="group-hover:text-gray-600 text-lg font-semibold text-gray-800 dark:text-white dark:group-hover:text-gray-400">Pronto para Baixar</h3>
        <p className="mt-1 text-gray-600 dark:text-neutral-400">Seu Design de Interiores está pronto</p>
      </div>
      <span className="mt-2 inline-flex items-center gap-x-1.5 text-sm text-blue-600 decoration-2 group-hover:underline font-medium">
    ...
    <a className="group flex flex-col justify-between h-full hover:bg-gray-50 rounded-xl p-4 md:p-7 dark:hover:bg-neutral-800" href="#">
      ...
      <div className="mt-5 flex-1">
        <h3 className="group-hover:text-gray-600 text-lg font-semibold text-gray-800 dark:text-white dark:group-hover:text-gray-400">Suporte 24/7</h3>
        <p className="mt-1 text-gray-600 dark:text-neutral-400">Contate-nos 24 horas por dia, 7 dias por semana</p>
      </div>
      <span className="mt-2 inline-flex items-center gap-x-1.5 text-sm text-blue-600 decoration-2 group-hover:underline font-medium">
